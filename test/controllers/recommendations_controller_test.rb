...
class RecommendationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create recommendation" do
    assert_difference('Recommendation.count') do
      post recommendations_url, params: { recommendation: { album_id: @recommendation.album_id, user_id: @recommendation.user_id } }
    end
  ...
  test "should update recommendation" do
    patch recommendation_url(@recommendation), params: { recommendation: { album_id: @recommendation.album_id, user_id: @recommendation.user_id } }
